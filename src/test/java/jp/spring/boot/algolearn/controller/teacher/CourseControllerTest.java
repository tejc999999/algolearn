...
//            Set<ClassCourseBean> classCourseBeanSet = courseBean.getClassCourseBeans();
//            assertEquals(classCourseBeanSet.size(), 1);
//            if (classCourseBeanSet != null) classCourseBeanSet.forEach(classCourseBean -> {
//                // TODO:あとで解除
////                    assertEquals(classCourseBean.getId().getCourseId(), 1);
////                    assertEquals(classCourseBean.getId().getClassId(), 1);
//                    ClassBean classBean = classCourseBean.getClassBean();
//                    assertEquals(classBean.getId(), 1);
//                    assertEquals(classBean.getName(), "クラス１");
//            });
//            Set<UserCourseBean> userCourseBeanSet = courseBean.getUserCourseBeans();
//            assertEquals(userCourseBeanSet.size(), 1);
//            if (userCourseBeanSet != null) userCourseBeanSet.forEach(userCourseBean -> {
//                assertEquals(userCourseBean.getId().getUserId(), "userid01");
//                assertEquals(userCourseBean.getId().getCourseId(), 1);
//                UserBean userBean = userCourseBean.getUserBean();
